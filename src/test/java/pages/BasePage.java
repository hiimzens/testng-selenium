...
public class BasePage {
    ...
    public WebElement waitForElementToBeVisible(boolean isLongWait, By locator) {
        ...
        WebDriverWait longWait = new WebDriverWait(driver, Duration.ofSeconds(LONG_TIMEOUT_IN_SECONDS));
        WebDriverWait shortWait = new WebDriverWait(driver, Duration.ofSeconds(TIMEOUT_IN_SECONDS));
        if (isLongWait) {
